...
- **Interface descriptions** — all active trunk and LAG member ports
...
interface range GigabitEthernet1/0/1, GigabitEthernet1/0/3-4, GigabitEthernet1/0/13, GigabitEthernet1/0/15, GigabitEthernet1/0/17, GigabitEthernet1/0/19
 power inline never
